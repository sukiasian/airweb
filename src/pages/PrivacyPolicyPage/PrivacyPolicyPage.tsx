...
import BlackPageHeading from "../../components/page-headings/BlackPageHeading"
import BlackBackground from "../../hoc/BlackBackground";

const PrivacyPolicyPage = (): JSX.Element => { 
	return <div className="page privacy-policy-page">
		<BlackPageHeading title='Privacy Policy' />
		<BlackBackground>
			<section className="policy-text"> 
				<div className="contact">
					<h1>Owner and Data Controller</h1>
					<p>Airweb Agency LLC - 30 N Gould St, Sheridan, WY, 82801</p>
					<p><b>Owner contact email:</b> team@airwebagency.com</p>
				</div>
				<div className="types-of-data"> 
					<h1> 
						Types of Data collected
					</h1>
					<p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Trackers; Usage Data; number of Users; session statistics.
				...
				<div className="users-info"> 
					...
					<h2>The rights of Users based on the General Data Protection Regulation (GDPR)</h2>
					<p>Users may exercise certain rights regarding their Data processed by the Owner.
						...
						• Object to processing of their Data. Users have the right to object to the processing of their Data if the processing is carried out on a legal basis other than consent.<br/> 
						...
						• Restrict the processing of their Data. Users have the right to restrict the processing of their Data. In this case, the Owner will not process their Data for any purpose other than storing it.<br/> 
						• Have their Personal Data deleted or otherwise removed. Users have the right to obtain the erasure of their Data from the Owner.<br/> 
						• Receive their Data and have it transferred to another controller. Users have the right to receive their Data in a structured, commonly used and machine readable format and, if technically feasible, to have it transmitted to another controller without any hindrance.<br/> 
				...
				<div className="definitions">
					<h1>Definitions and legal references</h1>
					...
					<h2>Data Processor (or Processor)</h2>
